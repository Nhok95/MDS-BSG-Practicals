...
```{r question_8, out.width = "80%", fig.align="center"}
...
```{r question_10, message=FALSE, warning=FALSE, results='hide'}
set.seed(123)
stress.list = c()
coordinates.list = c()
for(i in 1:100){
...
Our best run is the one with the lowest stress value, once we get the corresponding map we can show plot it.
```{r question_10_3, out.width = "80%", fig.align="center"}
...
We need 20 dimension to obtain a stress value below 5.
