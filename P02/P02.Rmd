...
96.16097% of the SNPs have a p-value over 0.05 (that entails that this SNPs have HWE). We can consider the other 3.83903% as imbalanced.
```{r}
...
The composition of the genotype is unusual in the sense that it contains a very high number of AB.
...
The composition of the genotype is unusual in the sense that it contains a very high number of...
...
When all the SNPs are shown simultaneously in a ternary plot, the...
